    ...
    <div className="hero py-4">
      <div className="container">
        <div className="flex items-center gap-3">
          <div className="left w-1/2 relative overflow-hidden rounded-[10px] before:absolute before:content-[''] before:w-full before:h-full before:bg-black before:opacity-[0.3] group before:transition-all before:duration-300 before:group-hover:opacity-0">
          ...
          <div className="right w-1/2 relative overflow-hidden rounded-[10px] before:absolute before:content-[''] before:w-full before:h-full before:bg-black before:opacity-[0.3] group before:transition-all before:duration-300 before:group-hover:opacity-0">
